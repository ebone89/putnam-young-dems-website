...
The **Get Involved** page (under Page Content) has its own small photo slideshow, separate from the main Photo Gallery — add one or more photos there and they'll cross-fade automatically under the page intro, with arrows and dots if there's more than one.
